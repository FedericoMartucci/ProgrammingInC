...
int main()
{
    ...
    */
    ...
    char line[MAXLINE] = "Hola, soy una oracion.";
    char* toBeTraversed = line;
    char* word;
    int wordLength;

//    quieroUnaLineaDeTextoOfuscadaV1(line);
//    printf("Linea original: %s\n", line);
//
//    desofuscar(line);
//    printf("Linea desofuscada: %s\n", line);
    while((wordLength = nextWord(&toBeTraversed, &word))){
        printf("WordLenght: %d - Word: ", wordLength);
